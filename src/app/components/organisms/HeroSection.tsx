        ...
        <div className="grid md:grid-cols-2 gap-10 md:gap-12 lg:gap-20 items-center -mt-20 md:-mt-30">
          ...
          >
            ...
            <motion.div
              ...
              style={{
                ...
                boxShadow:
                  "0px 0px 15px 0px rgba(247, 147, 26, 0.3)",
              }}
            ...
            >
              <h1 className="text-3xl md:text-5xl lg:text-6xl font-serif leading-tight">
                <span className="text-white">
                  {t("home.hero_unlock") || "Unlock"}{" "}
                </span>
                <span className="text-[#d4af37]">
                  {t("home.hero_vip_status") || "VIP Status"}
                </span>
              </h1>
            ...
            >
              {t("home.hero_desc_new_1") ||
                "Elevate your beauty experience with our"}{" "}
              <span className="text-white font-bold">
                {t("home.hero_membership_program") ||
                  "Membership Program"}
              </span>
              . {t("home.hero_enjoy_up_to") || "Enjoy up to"}{" "}
              <span className="text-[#f7931a] font-bold">
                {t("home.hero_cashback_20") || "20% Cashback"}
              </span>
              ,{" "}
              {t("home.hero_priority_access") ||
            ...
            >
              ...
              >
                <motion.button
                  ...
                  style={{
                    backgroundImage:
                      "linear-gradient(46.3281deg, rgb(247, 147, 26) 0%, rgb(255, 171, 46) 100%)",
                    boxShadow:
                      "0px 0px 20px 0px rgba(247, 147, 26, 0.4)",
                  }}
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                >
                  {t("home.cta_view_packages") ||
                    "VIEW PACKAGES"}
                </motion.button>
              </Link>
              <Link
          ...
          >
            ...
            <div
              ...
              style={{
                backgroundImage:
                  "linear-gradient(45deg, rgb(247, 147, 26) 0%, rgb(253, 224, 71) 100%)",
              }}
            />
              ...
              >
                <motion.div
                  ...
                  style={{
                    background: "rgba(0, 0, 0, 0.6)",
                    boxShadow:
                      "0px 0px 30px 0px rgba(212, 175, 55, 0.6), inset 0px 0px 20px 2px rgba(212, 175, 55, 0.2)",
                  }}
              ...
              >
                <motion.div
                  ...
                  style={{
                    background: "rgba(0, 0, 0, 0.6)",
                    boxShadow:
                      "0px 0px 30px 0px rgba(247, 147, 26, 0.6), inset 0px 0px 20px 2px rgba(247, 147, 26, 0.2)",
                  }}
                  animate={{ rotate: [348, 348] }}
                >
                  <span className="text-2xl font-black text-[#f7931a]">
                    %
                  </span>
                </motion.div>
              </FloatingIcon>
              ...
              >
                <motion.div
                  ...
                  style={{
                    background: "rgba(0, 0, 0, 0.6)",
                    boxShadow:
                      "0px 0px 30px 0px rgba(236, 72, 153, 0.8), inset 0px 0px 20px 2px rgba(236, 72, 153, 0.2)",
                  }}
                  animate={{ rotate: [6, 6] }}
                >
              ...
              >
                <motion.div
                  ...
                  style={{
                    background: "rgba(0, 0, 0, 0.6)",
                    boxShadow:
                      "0px 0px 30px 0px rgba(168, 85, 247, 0.8), inset 0px 0px 20px 2px rgba(168, 85, 247, 0.2)",
                  }}
                  animate={{ rotate: [348, 348] }}
                >
              ...
              >
                <motion.div
                  ...
                  style={{
                    background: "rgba(0, 0, 0, 0.6)",
                    boxShadow:
                      "0px 0px 30px 0px rgba(45, 212, 191, 0.8), inset 0px 0px 20px 2px rgba(45, 212, 191, 0.2)",
                  }}
              ...
              >
                <motion.div
                  ...
                  style={{
                    background: "rgba(0, 0, 0, 0.6)",
                    boxShadow:
                      "0px 0px 30px 0px rgba(74, 222, 128, 0.8), inset 0px 0px 20px 2px rgba(74, 222, 128, 0.2)",
                  }}
                  animate={{ rotate: [12, 12] }}
                >
              ...
              >
                <motion.div
                  ...
                  style={{
                    background: "rgba(0, 0, 0, 0.6)",
                    boxShadow:
                      "0px 0px 30px 0px rgba(96, 165, 250, 0.8), inset 0px 0px 20px 2px rgba(96, 165, 250, 0.2)",
                  }}
                ...
                >
                  ...
                  <div
                    ...
                    style={{
                      ...
                      height: "100%",
                      backgroundImage:
                        "linear-gradient(149.871deg, rgb(17, 18, 23) 0%, rgb(0, 0, 0) 100%)",
                      boxShadow:
                  ...
                  >
                    ...
                    <div className="relative flex flex-col justify-between p-[6%] h-full">
                      ...
                      <div className="flex justify-between items-start">
                        <div className="flex items-center gap-2">
                          ...
                          <div className="w-[12%] aspect-square rounded-full border border-[#eab308] shadow-[0px_4px_6px_-1px_rgba(0,0,0,0.1)] flex items-center justify-center">
                            <span className="text-[#eab308] text-[2.5cqw] md:text-sm">
                              ₿
                            </span>
                          </div>
                          {/* Text */}
                          <div className="flex flex-col">
                            <span className="text-[#eab308] font-serif font-bold text-[2.5cqw] md:text-[9px] tracking-[0.225px] leading-tight">
                              GOLD
                            </span>
                            <span className="text-[#9ca3af] font-sans font-bold text-[1.25cqw] md:text-[4.5px] tracking-[0.9px] leading-tight">
                              {t("nav.membership") ||
                                "MEMBERSHIP"}
                            </span>
                          </div>
                        ...
                        <div className="text-[#6b7280]">
                          <svg
                            viewBox="0 0 24 24"
                            fill="none"
                            className="w-[5cqw] h-[5cqw] md:w-6 md:h-6"
                            stroke="currentColor"
                            strokeWidth="2"
                            strokeLinecap="round"
                      ...
                      <div className="flex justify-between items-end">
                        <div>
                          <div className="text-[#6b7280] font-sans text-[1cqw] md:text-[3.6px] tracking-[0.36px] uppercase">
                            {t("home.card_valid_thru") ||
                              "VALID THRU"}
                          </div>
                          <div className="text-[#9ca3af] font-mono font-bold text-[2cqw] md:text-[7.2px]">
                            12/25
                          </div>
                        </div>
                        <div className="backdrop-blur-sm bg-[rgba(234,179,8,0.2)] border border-[rgba(234,179,8,0.3)] rounded-[4px] px-[3%] py-[2%]">
                          <div className="text-[#eab308] font-sans font-bold text-[2.5cqw] md:text-[9px] uppercase">
                            {t("home.card_10_off") || "10% OFF"}
                          </div>
                        </div>
                      </div>
                    </div>
            ...
            >
              <div
                ...
                style={{
                  ...
                  aspectRatio: "398/260",
                  backgroundImage:
                    "linear-gradient(149.871deg, rgb(10, 10, 10) 0%, rgb(26, 26, 26) 100%)",
                  boxShadow:
                    "0px 0px 50px 0px rgba(247, 147, 26, 0.3)",
                }}
              >
                {/* Background Pattern */}
                <div
                ...
                <div className="relative flex flex-col justify-between h-full">
                  ...
                  <div className="flex justify-between items-start">
                    ...
                    <div className="opacity-80 text-[#9ca3af]">
                      <svg
                        viewBox="0 0 24 24"
                        fill="none"
                        className="w-[6cqw] h-[6cqw] md:w-6 md:h-6"
                        stroke="currentColor"
                        strokeWidth="2"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                  ...
                  {/* Chip */}
                  <div
                    className="relative w-[12%] aspect-[48/36] rounded-[6px] border border-[rgba(253,224,71,0.5)]"
                    style={{
                      backgroundImage:
                        "linear-gradient(143.13deg, rgb(254, 240, 138) 0%, rgb(250, 204, 21) 50%, rgb(202, 138, 4) 100%)",
                    }}
                  >
                  ...
                  <div className="space-y-[4%]">
                    ...
                    <div className="flex justify-between items-end">
                      <div>
                        <div className="text-[#d1d5db] text-[1cqw] md:text-[4px] uppercase tracking-[0.4px]">
                          {t("home.card_valid_thru") ||
                            "VALID THRU"}
                        </div>
                        <div className="text-white text-[2cqw] md:text-[8px] font-mono font-bold">
                          12/30
                        </div>
                      </div>
                      <div className="flex flex-col items-end gap-[4px]">
                        <div className="text-[#e5e7eb] text-[1.5cqw] md:text-[6px] font-serif italic uppercase tracking-[0.6px]">
                          {t("home.card_cashback") ||
                            "CASHBACK"}
                        </div>
                        <div className="backdrop-blur-sm bg-[rgba(0,0,0,0.4)] border border-[rgba(247,147,26,0.3)] rounded-[4px] px-[9px] py-[6px]">
                          <span className="text-[#f7931a] font-mono font-bold text-[2.5cqw] md:text-[10px]">
                            20%
                          </span>
                        </div>
                      </div>
              ...
              <Link to="/booking">
                <motion.button
                  onClick={(e) => {
                    e.preventDefault();
                    const element =
                      document.getElementById("egift-section");
                    if (element) {
                  ...
                  style={{
                    background: "rgba(0, 0, 0, 0.6)",
                    boxShadow:
                      "0px 0px 25px 0px rgba(247, 147, 26, 0.3)",
                  }}
                  whileHover={{
                    scale: 1.05,
                    boxShadow:
