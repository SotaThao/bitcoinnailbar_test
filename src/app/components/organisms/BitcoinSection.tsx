          ...
          >
            <div className="space-y-4">
              ...
              <div className="space-y-1">
                ...
                <h2
                  className="text-4xl md:text-5xl font-serif font-bold text-[#FF9800] leading-tight"
                  style={{
            ...
            <div className="space-y-8">
              <div className="flex gap-5">
                ...
                <div>
                  <h3 className="text-xl font-bold text-white mb-2">
                    {t("home.bnb_section.feature_1_title")}
                  </h3>
              ...
              <div className="flex gap-5">
                ...
                <div>
                  <h3 className="text-xl font-bold text-white mb-2">
                    {t("home.bnb_section.feature_2_title")}
                  </h3>
                  <p className="text-gray-400 text-sm leading-relaxed max-w-sm">
            ...
            <div className="pt-2">
              <a
                href="https://vlinkpay.com?ref=6145CBD8&parent=6145CBD8&leg=left"
                target="_blank"
