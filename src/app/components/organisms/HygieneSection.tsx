        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center max-w-7xl mx-auto">
          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4">
              {Array.isArray(t("home.hygiene.items")) &&
                (t("home.hygiene.items") as string[]).map(
                  (item, i) => (
                    <div
                      key={i}
          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4">
              {Array.isArray(t("home.services.items")) &&
                (t("home.services.items") as string[]).map(
                  (item, i) => (
                    <div
                      key={i}
                      className="flex items-start gap-3"
            ...
            <div className="pt-4">
              <Link to="/menu">
                <PrimaryButton
                  size="lg"
                  className="font-bold shadow-lg shadow-[#FF9800]/20 hover:shadow-[#FF9800]/40 transition-shadow"
                >
                  {t("home.services.btn")}
                </PrimaryButton>
              </Link>
