    ...
    <>
      ...
      {showText && (
        <div className="flex items-baseline gap-1.5 text-[14px]">
          <span
            className={`font-serif font-bold ${textSizeClasses[size]} text-white tracking-widest group-hover:text-[#FF9800] transition-colors whitespace-nowrap`}
          >
            BITCOIN
          </span>
          <span
            className={`font-serif font-bold ${textSizeClasses[size]} text-[#FF9800] tracking-widest group-hover:text-white transition-colors whitespace-nowrap`}
          >
            NAIL BAR
          </span>
        </div>
