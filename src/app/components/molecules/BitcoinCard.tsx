  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle, rgba(255, 152, 0, 0.6) 0%, rgba(255, 152, 0, 0.2) 50%, transparent 70%)",
        }}
      />
      ...
      <motion.div
        ...
        style={{
          ...
          boxShadow:
            "0 0 40px rgba(255, 152, 0, 0.4), inset 0 0 20px rgba(255, 152, 0, 0.1)",
          width: "340px",
          height: "214px",
        }}
        initial={{ y: 0 }}
      ...
      >
        ...
        <div className="flex justify-between items-start mb-8 md:mb-12">
          <div className="flex items-center gap-2">
            ...
            <div className="text-left">
              <div className="text-white font-bold text-xs md:text-sm tracking-wider">
                BITCOIN NAIL BAR
              </div>
              <div className="text-[#FF9800] text-[10px] md:text-xs tracking-wide">
                THE UNDERGROUND
              </div>
            </div>
          </div>
        ...
        <div className="flex justify-between items-end">
          <div>
            <div className="text-gray-400 text-[10px] md:text-xs uppercase tracking-wider mb-1">
              Valid Thru
            </div>
