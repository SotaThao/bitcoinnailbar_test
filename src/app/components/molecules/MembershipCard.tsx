...
export function MembershipCard({
  ...
  const handleJoinNow = async () => {
    ...
    try {
      // 🔍 DEBUG: Log tier info before sending
      console.log("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
      console.log("🎯 [PAYMENT] User clicked on tier:");
      console.log("   Tier ID:", tier.id);
      console.log("   Tier Name (internal):", tier.name);
      console.log("   Display Name:", tier.display_name);
      console.log("   Price:", tier.price);
      console.log("   Billing Cycle:", tier.billing_cycle);
      console.log(
        "   Duration (months):",
        tier.billing_cycle === "year"
          ? 12
          : tier.billing_cycle === "month"
            ? 1
            : 0.25,
      );
      console.log("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
      ...
      alert(
        "Đã xảy ra lỗi khi tạo liên kết thanh toán. Vui lòng thử lại.",
      );
    } finally {
      ...
      >
        ...
        >
          ...
          <div
            ...
            style={{
              background: `radial-gradient(circle at center, ${visual.glowColor}, transparent 70%)`,
            }}
          />
          ...
          <div className="flex flex-col items-center pt-8 mb-8">
            ...
            `}
              style={{
                boxShadow: `0 0 15px ${visual.glowColor}`,
              }}
            >
            ...
            <h3
              className={`text-2xl font-serif font-bold mb-2 tracking-widest uppercase ${tier.color}`}
            >
              {tier.display_name}
            </h3>
            ...
            <div className="text-center relative">
              <div
                className="flex items-baseline justify-center gap-1 text-white"
                style={{
                  textShadow: visual.popular
          ...
          <div
            ...
            style={{
              background: `linear-gradient(90deg, transparent, ${visual.hexColor}40, transparent)`,
            }}
          />
          ...
          <ul className="space-y-4 mb-8 flex-grow">
            {tier.benefits.map(
              (feature: string, idx: number) => (
                ...
                >
                  <div
                    className={`mt-0.5 min-w-[14px] ${tier.name === "silver" ? "text-[#eab308]" : tier.name === "vip-crypto" ? "text-[#f7931a]" : tier.color}`}
                  >
