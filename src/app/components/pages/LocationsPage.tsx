          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
            ...
            <Card className="shadow-xl border-t-4 border-[#FF9800] bg-white h-full">
              <CardContent className="p-8 space-y-8 h-full flex flex-col justify-between">
                <div>
                  <div className="mb-6">
                    <h2 className="text-3xl font-serif font-bold text-[#0B0F19] mb-2">
                      Houston Headquarters
                    </h2>
                    <p className="text-[#FF9800] font-medium tracking-wide text-sm uppercase">
                      Flagship Location
                    </p>
                  </div>

                  <p className="text-gray-500 mb-8 leading-relaxed">
                    Experience the future of beauty in our
                    flagship 10,000 SQFT facility. Featuring
                    private VIP suites, a full cocktail bar, and
                ...
                <div className="pt-6">
                  <a
                    href="https://maps.google.com/?q=9793+Westheimer+Rd,+Houston,+TX+77042"
                    target="_blank"
