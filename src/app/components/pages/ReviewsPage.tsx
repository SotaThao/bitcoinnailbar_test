...
export default function ReviewsPage() {
  ...
  const mockReviews = [
    {
      ...
      rating: 5,
      comment:
        "Absolutely stunning place! The Bitcoin theme is so unique and the pedicure was heavenly.",
      date: "2024-02-15",
    },
    {
      id: 2,
      ...
      rating: 5,
      comment:
        "Paid with BTC via Lightning Network. Super fast and easy. The staff is very professional.",
      date: "2024-02-10",
    },
    {
      id: 3,
      ...
      rating: 4,
      comment:
        "Great service, a bit pricey but worth it for the luxury experience. The chairs are incredibly comfortable.",
      date: "2024-01-28",
    },
    {
      id: 4,
      ...
      rating: 5,
      comment:
        "The Diamond Gel Manicure is a must-try! My nails have never looked better. Highly recommend booking the VIP suite.",
      date: "2024-03-01",
    },
    {
      id: 5,
      ...
      rating: 5,
      comment:
        "Finally a place where I can talk crypto while getting a foot massage. Great atmosphere!",
      date: "2024-02-22",
    },
    {
      id: 6,
      ...
      rating: 4,
      comment:
        "Love the complimentary cocktails. The technicians are very skilled with nail art.",
      date: "2024-02-05",
    },
  ];
  ...
  const renderStars = (rating: number) => {
    return [...Array(5)].map((_, i) => (
      <Star
        key={i}
        className={`w-4 h-4 ${i < rating ? "fill-[#FF9800] text-[#FF9800]" : "text-gray-300"}`}
      />
    ));
  };
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16 space-y-4">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto text-lg">
              See what our clients are saying about the Bitcoin
              Nail Bar experience.
            </p>
          </div>
          ...
          <div className="bg-white rounded-2xl p-8 shadow-xl border border-gray-100 mb-16 flex flex-col lg:flex-row items-center justify-center gap-12 lg:gap-24 max-w-5xl mx-auto">
            <div className="text-center">
              <div className="text-7xl font-bold text-[#FF9800] font-serif">
                4.9
              </div>
              <div className="flex justify-center gap-1 my-3">
                {[1, 2, 3, 4, 5].map((i) => (
                  <Star
                    key={i}
                    className="w-6 h-6 fill-[#FF9800] text-[#FF9800]"
                  />
                ))}
              </div>
