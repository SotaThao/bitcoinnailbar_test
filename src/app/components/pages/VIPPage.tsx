        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <h1 className="text-5xl md:text-7xl font-serif font-bold">
              {t("home.vip_club.title_1")}
              <br />
              {t("home.vip_club.title_2")}
            </h1>

            <p className="text-xl text-gray-300 max-w-2xl mx-auto leading-relaxed">
              {t("home.vip_club.desc_part_1")}{" "}
              <span className="text-white font-semibold">
                Bitcoin Nail Bar
              </span>{" "}
              {t("home.vip_club.desc_part_2")}
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                ...
                return (
                  <div
                    key={i}
                    className="bg-white rounded-xl p-8 shadow-lg border-t-4 border-[#FF9800] hover:shadow-xl transition-shadow"
                  >
      ...
      <section className="py-20 bg-[#0B0F19] text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-gray-300 mb-12 max-w-2xl mx-auto">
            Fill out the form and start enjoying exclusive VIP
            benefits today
          </p>
