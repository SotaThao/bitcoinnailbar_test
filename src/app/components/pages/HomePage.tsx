...
export default function HomePage() {
  const structuredData = {
    ...
    image:
      "https://images.unsplash.com/photo-1632345031435-8727f68979a6?auto=format&fit=crop&q=80",
    description:
      "Luxury nail salon in Houston accepting Bitcoin. Experience premium manicures, pedicures, and spa services.",
    address: {
      "@type": "PostalAddress",
