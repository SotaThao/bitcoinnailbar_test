...
export default function CheckInPage() {
  ...
  const handleAction = async (
    ...
    try {
      const response = await fetch(
        `https://${projectId}.supabase.co/functions/v1/make-server-84f9c112/appointments/${appointment.id}`,
        {
          method: "PUT",
          headers: {
    ...
    <div className="min-h-screen bg-black text-white p-4 flex items-center justify-center">
      <Card className="w-full max-w-md bg-zinc-900 border-zinc-800 text-white shadow-2xl">
        <CardHeader className="text-center border-b border-zinc-800 pb-6">
          <CardTitle className="text-3xl font-serif text-[#FF9800] mb-2">
            Self Check-in
          </CardTitle>
        ...
        <CardContent className="pt-6 space-y-6">
          ...
          <div>
            ...
            <div className="space-y-2">
              ...
              Array.isArray(appointment.serviceNames) ? (
