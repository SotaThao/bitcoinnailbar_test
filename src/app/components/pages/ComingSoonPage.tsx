        ...
        <div className="container px-4 relative z-10 text-center">
            ...
            <div className="space-y-6 max-w-2xl mx-auto">
                ...
                <h1 className="text-4xl md:text-6xl font-serif font-bold tracking-wide">
                    ...
                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FF9800] to-[#F57C00]">{t('coming_soon.title_2')}</span>
                </h1>
                ...
                <div className="pt-8 flex justify-center gap-4">
                    ...
                    <AnimatedButton to="/booking" className="rounded-full px-8 h-12 text-base font-bold">
            ...
            <div className="mt-20 flex items-center justify-center gap-8 opacity-30 grayscale hover:grayscale-0 transition-all duration-500">
                <img src={bitcoinLogo} alt="Bitcoin" className="h-12 w-12 opacity-50" />
            </div>
        </div>
      </div>
    </PublicLayout>
