...
export const cardColors: CardColor[] = [
  {
    id: "bitcoin-black",
    name: "Bitcoin Black",
    gradient: "from-[#1F2937] to-[#000000]",
    borderColor: "#F7931A",
    isLight: false,
  },
  {
    id: "platinum",
    name: "Platinum",
    gradient: "from-[#FFFFFF] to-[#D1D5DB]",
    borderColor: "#9CA3AF",
    isLight: true,
  },
  {
  ...
  },
  {
    id: "sapphire",
    name: "Sapphire",
    gradient: "from-[#2563EB] to-[#312E81]",
    borderColor: "#60A5FA",
    isLight: false,
  },
  {
  ...
  },
  {
    id: "gold",
    name: "24K Gold",
    gradient: "from-[#F9E6AA] via-[#D4AF37] to-[#996515]",
    borderColor: "#FEF08A",
    isLight: true,
  },
  {
...
export function EGiftCardPreview({
  ...
  const textPrimary = selectedColor.isLight
    ? "text-gray-900"
    : "text-white";
  const textSecondary = selectedColor.isLight
    ? "text-gray-700"
    : "text-white/80";
  const textTertiary = selectedColor.isLight
    ? "text-gray-600"
    : "text-white/60";
  const textMuted = selectedColor.isLight
    ? "text-gray-500"
    : "text-white/40";
  const accentColor = selectedColor.isLight
    ? "text-[#D97706]"
    : "text-[#FFD700]"; // Amber for light, Gold for dark
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <div
              className={`w-full h-full bg-gradient-to-tl ${selectedColor.gradient} p-[5.5%] relative flex flex-col justify-between select-none shadow-inner group overflow-hidden font-mono`}
            >
              {/* Dot Pattern Overlay */}
              <div
              ...
              <div className="flex justify-between items-center relative z-10 h-[22%]">
                <div className="flex items-center gap-[4%] h-full">
                  ...
                  <div className="flex flex-col justify-center h-full pt-[1%]">
                    <span
                      className={`${textPrimary} text-[4.5cqw] font-serif font-bold tracking-[0.02em] leading-none mb-[3%] drop-shadow-md whitespace-nowrap`}
                    >
                      BITCOIN NAIL BAR
                    </span>
                    <span
                      className={`${textSecondary} text-[2cqw] tracking-[0.2em] font-medium uppercase leading-none pl-[2px]`}
                    >
                      LUXURY GIFT CARD
                    </span>
                  </div>
                ...
                {/* Contactless Symbol */}
                <div
                  className={`h-[50%] aspect-square ${textMuted} flex items-center justify-center mr-[2%]`}
                >
                  <svg
                    viewBox="0 0 24 24"
                    fill="none"
              ...
              <div className="flex justify-between items-center relative z-10 pl-[1%] pr-[1%] mt-[2%]">
                ...
                <div className="flex flex-col items-end mr-[1%]">
                  <span
                    className={`${textMuted} text-[1.8cqw] font-bold tracking-[0.15em] uppercase leading-none mb-[1%]`}
                  >
                    Balance
                  </span>
                  <div
                    className={`flex items-start leading-none ${textPrimary} font-bold drop-shadow-md`}
                  >
                    <span className="text-[3.5cqw] mr-[2px] mt-[4%] opacity-90">
                      $
                    </span>
              ...
              <div className="flex flex-col justify-end relative z-10 flex-1 pb-[1%]">
                {/* Card Number */}
                <div
                  className={`${textPrimary} text-[5.5cqw] font-mono tracking-[0.14em] drop-shadow-md text-left w-full pl-[1%] mb-[3%]`}
                >
                  4589 1234 5678 9010
                </div>
                ...
                <div className="flex justify-between items-end pl-[1%]">
                  <div className="flex flex-col items-start gap-[0.5cqw]">
                    <div className="flex items-center gap-[2cqw]">
                      {/* Valid Thru */}
                      <div
                        className={`flex flex-col ${textTertiary} text-[1.2cqw] leading-tight uppercase tracking-[0.1em] font-bold`}
                      >
                        <span>VALID</span>
                        <span>THRU</span>
                      </div>
                      <div
                        className={`${textPrimary} text-[3.2cqw] font-mono font-medium tracking-widest drop-shadow-sm`}
                      >
                        12/30
                      </div>
                    </div>
                    {/* Recipient Name */}
                    <div
                      className={`${textPrimary} text-[3.2cqw] font-medium tracking-[0.05em] uppercase whitespace-nowrap drop-shadow-sm`}
                    >
                  ...
                  <div
                    className={`${textMuted} italic font-serif text-[3.5cqw] tracking-[0.05em] font-bold`}
                  >
                    E-GIFT
                  </div>
                </div>
            ...
            <div className="w-full h-full relative flex flex-col p-[4%]">
              ...
              <div className="absolute top-[6%] left-0 right-0 h-[16%] bg-[#1a1a1a]">
                <div
                  ...
                  style={{
                    backgroundImage:
                      "linear-gradient(90deg, #000 0%, #222 50%, #000 100%)",
                  }}
                />
              </div>
              ...
              <div className="mt-[25%] flex items-center gap-[3%] px-[4%]">
                <div className="flex-1 h-[32px] bg-white relative flex items-center px-2">
                  <span className="relative z-10 font-serif italic text-gray-400 text-[2.5cqw]">
                    Authorized Signature
                  </span>
                </div>
                <div className="w-[12%] h-[32px] bg-white flex items-center justify-center border border-gray-300">
                  <span className="font-mono font-bold italic text-black text-[3cqw]">
                    982
                  </span>
                </div>
              </div>
              ...
              <div className="mt-[4%] px-[4%] text-[#6b7280] text-[1.8cqw] leading-tight text-justify">
                This card is issued by Bitcoin Nail Bar.
                Redeemable for services & products only. Treat
                this card like cash. Lost or stolen cards may
                not be replaced.
              </div>
              ...
              <div className="mt-auto flex items-end justify-between px-[4%] pb-[2%] border-t border-[#1f2937] pt-[2%]">
                <div className="space-y-[2%]">
                  <div className="flex items-center gap-2 text-[2cqw]">
                    <span className="text-[#f7931a] w-3">
                      📞
                    </span>
