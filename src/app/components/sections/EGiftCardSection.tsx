...
export function EGiftCardSection() {
  ...
  return (
    <section
      id="egift-section"
      className="relative py-24 bg-gradient-to-b from-[#0B0F19] via-[#1A1F2E] to-[#0B0F19] overflow-hidden"
    >
      {/* Background Effects */}
      ...
      <div className="container mx-auto px-4 relative z-10 mt-[-60px]">
        ...
        >
          ...
          <h2 className="text-4xl md:text-6xl font-serif font-bold mb-6">
            ...
            <span className="text-white">
              {" "}
              {t("egift.instantly") || "Instantly"}
            </span>
          </h2>

          <p className="text-lg text-gray-300 leading-relaxed">
            {t("egift.desc") ||
              "Surprise your loved ones with a digital key to relaxation. Delivered instantly via Email/SMS."}
          </p>
        </motion.div>
