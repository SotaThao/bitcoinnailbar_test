...
import { Gift, CreditCard, Mail, CheckCircle, Search } from 'lucide-react';
...
export function RedeemSection() {
  const [activeTab, setActiveTab] = useState<'redeem' | 'check'>('redeem');
  const { t } = useLanguage();

  return (
    <section id="redeem-section" className="py-16 bg-[#0f1219] relative overflow-hidden">
      {/* Background Elements */}
              ...
              <div className="space-y-4">
                <div className="flex gap-4">
                  ...
                  <div className="flex-1">
                    <h4 className="text-white font-semibold mb-1">{t('redeem.instructions.step1.title')}</h4>
                ...
                <div className="flex gap-4">
                  ...
                  <div className="flex-1">
                    <h4 className="text-white font-semibold mb-1">{t('redeem.instructions.step2.title')}</h4>
                    <p className="text-sm text-gray-400">
