...
export default function AdminAppointments() {
  ...
  const { appointments, loading: loadingAppointments, updateStatus, refetch } = useAppointments();
  ...
  const filteredAppointments = appointments.filter(appt => {
    ...
    const matchesDate = !date || isSameDay(new Date(appt.appointmentTime), date);
          ...
          <CardHeader>
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
              <div>
                ...
                <CardDescription className="text-gray-500">View and manage customer bookings</CardDescription>
              </div>
        ...
        {sortedAppointments.length === 0 ? (
          ...
          <div className="space-y-4">
            {sortedAppointments.map((appointment) => {
              ...
              const displayServices = resolveAppointmentServices(appointment, services);
              const totalAmount = calculateTotalAmount(displayServices);
