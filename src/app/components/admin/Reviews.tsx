  ...
  const reviews = [
    {
      ...
      date: "2 hours ago",
      comment:
        "Absolutely amazing experience! The gold soak was luxurious.",
      status: "pending",
    },
    {
      id: 2,
    ...
    },
    {
      ...
      date: "3 days ago",
      comment:
        "Best nail art in Houston! Truly a queen experience.",
      status: "approved",
    },
  ];
    ...
    <AdminLayout>
      <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-between">
          ...
          >
            <PillTabsList>
              <PillTabsTrigger value="pending">
                Pending (2)
              </PillTabsTrigger>
              <PillTabsTrigger value="approved">
                Approved
              </PillTabsTrigger>
              <PillTabsTrigger value="rejected">
                Rejected
              </PillTabsTrigger>
            </PillTabsList>
          </PillTabs>
        ...
        <div className="grid gap-4">
          {reviews
            ...
            .map((review) => (
              <Card
                key={review.id}
                className="bg-white border-gray-100 hover:shadow-md transition-all shadow-sm"
              >
                    ...
                    <div className="flex md:flex-col gap-2 justify-end md:justify-center border-t md:border-t-0 md:border-l border-gray-100 pt-4 md:pt-0 md:pl-6">
                      {review.status === "pending" && (
                        <>
                          <Button
                            size="sm"
                            className="bg-green-50 text-green-700 hover:bg-green-100 border border-green-200 shadow-none w-full justify-start"
                          >
                          ...
                          <Button
                            size="sm"
                            variant="outline"
                            className="text-red-600 border-gray-200 hover:bg-red-50 hover:text-red-700 hover:border-red-200 w-full justify-start"
                          >
                      ...
                      {review.status !== "pending" && (
                        <span
                          className={`px-3 py-1 rounded-full text-xs font-bold uppercase text-center border ${
