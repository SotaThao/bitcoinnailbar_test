...
export default function AdminSettings() {
  ...
  const [homepageMenuMode, setHomepageMenuMode] = useState<
    "services-list" | "menu-images"
  >("services-list");
  const [savingMenuMode, setSavingMenuMode] = useState(false);
  const [chatbotAvatar, setChatbotAvatar] =
    useState<string>("");
  const [chatbotAvatarPath, setChatbotAvatarPath] =
    useState<string>("");
  ...
  const handleSave = async () => {
    ...
    try {
      const result =
        await apiClient.settings.updateSocialMedia(socialMedia);
    ...
    try {
      ...
      if (data.success) {
        toast.success("✅ Chatbot avatar updated!", {
          description:
            "The new avatar will appear in the chatbot widget.",
        });
      } else {
        throw new Error(data.error || "Failed to save");
      }
      ...
      <div className="space-y-6 max-w-4xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-500">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">
            Manage your business settings and social media
            links.
          </p>
        </div>
        ...
        <Card className="bg-white border-gray-200 shadow-sm">
          <CardHeader>
            ...
            <CardDescription className="text-gray-500">
              Update your social media profiles. Leave blank to
              hide the icon from footer.
            </CardDescription>
          </CardHeader>
        ...
        <Card className="bg-white border-gray-200 shadow-sm">
          <CardHeader>
            ...
            <CardDescription className="text-gray-500">
              Choose how the menu is displayed on the homepage
              kiosk
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <button
                onClick={() =>
                  setHomepageMenuMode("services-list")
                }
              ...
              <button
                onClick={() =>
                  setHomepageMenuMode("menu-images")
                }
                className={`p-4 rounded-lg border-2 transition-all ${
