      ...
      <div className="space-y-8">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Revenue breakdown by day this month
            </CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          ...
          <CardContent>
            <div className="h-[300px]">
              <ResponsiveContainer width="100%" height="100%">
                <BarChart
                  data={analytics.dailyRevenue.slice(-7)}
                >
                  <CartesianGrid strokeDasharray="3 3" />
                  <XAxis
                    dataKey="date"
                  ...
                  <Tooltip
                    ...
                    labelFormatter={(value) =>
                      format(new Date(value), "EEEE, MMM d")
                    }
                  />
