...
interface CategoryFormSheetProps {
  ...
  onSave: (category: Omit<ServiceCategory, 'id'> | ServiceCategory) => Promise<boolean>;
}
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1">
                <span className={`font-semibold ${formData.status === 'active' ? 'text-green-600' : 'text-gray-500'}`}>
