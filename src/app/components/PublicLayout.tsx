          ...
          result.data
            ...
            .forEach((img: any) => {
              if (!seenNames.has(img.name)) {
                uniqueMenus.push({ id: img.id, name: img.name, order: img.order });
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-[1.5fr_auto_auto] gap-8 lg:gap-24">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-3 pt-2">
                 ...
                 <div className="flex flex-wrap items-center gap-3">
                    ...
                    {/* USDC */}
                    <div className="group relative flex items-center justify-center w-12 h-12 rounded-lg text-[#2775CA] transition-all duration-200" title="USDC">
                      <img src={image_5eb8a93cb1061aa87f464278bcfce42201277b32} alt="USDT/USDC" className="w-full h-full object-contain" />
            ...
            <div className="lg:w-fit grid grid-cols-2 gap-8 lg:gap-12">
              <div>
                <h3 className="font-medium mb-4 text-white">{t('footer.quick_links')}</h3>
                <ul className="space-y-2 text-sm">
                  <li><Link to="/services" className="text-gray-400 hover:text-[#FF9800] transition-colors">{t('nav.services')}</Link></li>
                  <li><Link to="/booking" className="text-gray-400 hover:text-[#FF9800] transition-colors">{t('nav.booking')}</Link></li>
                  <li><Link to="/locations" className="text-gray-400 hover:text-[#FF9800] transition-colors">{t('nav.locations')}</Link></li>
                  <li><Link to="/reviews" className="text-gray-400 hover:text-[#FF9800] transition-colors">{t('nav.reviews')}</Link></li>
                </ul>
              </div>

              <div>
                <h3 className="font-medium mb-4 text-white">{t('footer.popular_services')}</h3>
                <ul className="space-y-2 text-sm text-gray-400">
                  <li>{t('services_page.categories.signature.items.0.name')}</li>
                  <li>{t('services_page.categories.signature.items.1.name')}</li>
                  <li>{t('services_page.categories.signature.items.2.name')}</li>
                  <li>{t('services_page.categories.comprehensive.items.3.name') || "Nail Art"}</li>
                </ul>
              </div>
            </div>
            ...
            <div className="lg:w-fit">
              <h3 className="font-medium mb-4 text-white">{t('footer.contact')}</h3>
              <ul className="space-y-2 text-sm text-gray-400">
                <li className="flex items-center gap-2">
                  <MapPin className="h-4 w-4 text-[#FF9800]" />
                  <span>9793 Westheimer Rd, Houston, TX 77042</span>
                </li>
                <li className="flex items-center gap-2">
                  <span className="text-[#FF9800] font-bold">Store:</span>
                  <span>(346) 802-4906</span>
                </li>
                <li className="flex items-center gap-2">
                  <span className="text-[#FF9800] font-bold">Sale:</span>
                  <span>(832) 799-3990</span>
                </li>
                <li className="flex items-center gap-2">
                  <span className="text-[#FF9800] font-bold">E:</span>
          ...
          <div className="border-t border-white/5 mt-8 pt-8 text-center text-sm text-gray-500">
            ...
            <p>&copy; 2026 Bitcoin Nail Bar. {t('footer.rights')}</p>
            <Link to="/admin">
              <Button variant="ghost" size="sm" className="h-6 text-[10px] uppercase tracking-widest text-gray-700 hover:text-[#f7931a] hover:bg-transparent transition-colors">
                Admin Portal
              </Button>
            </Link>
          </div>
