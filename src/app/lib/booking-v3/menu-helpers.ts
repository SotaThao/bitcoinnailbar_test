 ...
 *
 * POS gốc chưa có entity add-on riêng, nên add-on và giá member được nhúng
 * vào chuỗi description dạng `[ADDONS:...]` / `[MEMBER:$xx]`. Giữ nguyên
 * cách đọc để dữ liệu port sang không phải viết lại.
 */
