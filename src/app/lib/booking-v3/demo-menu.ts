/**
 * Menu demo của Bitcoin Nail Bar dùng cho route /booking-v3.
 *
 * Port nguyên dữ liệu từ `src/data/seedPosDemoMenu.ts` của NEXORA TOUCH
 * (vlink-nexora-fe, branch `feature/800_pos-menu-upsell`). Phần gọi
 * repository để seed lên API đã bỏ — ở đây chỉ cần dữ liệu tĩnh.
 */
