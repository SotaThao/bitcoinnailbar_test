...
function Background() {
  return (
    <div className="absolute bg-gradient-to-r content-stretch flex from-[#111827] inset-0 items-center justify-center to-black" data-name="Background">
...
function Background2() {
  return (
    <div className="absolute bg-gradient-to-r content-stretch flex from-[#1e3a8a] inset-0 items-center justify-center opacity-0 to-black" data-name="Background">
...
function Container14() {
  return (
    <div className="absolute bottom-[17px] h-[12px] left-[47.46%] right-[47.46%]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <div className="absolute bg-white left-[-1.5px] rounded-[9999px] size-[15px] top-[-1.5px]" data-name="Button" />
        <div className="absolute bg-[#4b5563] left-[20px] rounded-[9999px] size-[12px] top-0" data-name="Button" />
        <div className="absolute bg-[#4b5563] left-[40px] rounded-[9999px] size-[12px] top-0" data-name="Button" />
      </div>
    </div>
  );
}
